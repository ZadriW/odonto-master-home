...
(function() {
    ...
    function init() {
        ...
        setTimeout(function() { initSignupErrorOverlay(); setupEmailRealTimeValidation(); }, 500);
        setTimeout(function() { initSignupErrorOverlay(); setupEmailRealTimeValidation(); }, 1000);
        setTimeout(function() { initSignupErrorOverlay(); setupEmailRealTimeValidation(); }, 2000);
    }
    ...
    // Usa MutationObserver para detectar quando o formulário é adicionado dinamicamente
